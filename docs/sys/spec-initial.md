# sterminal — Especificación inicial

> **CONGELADO.** Este documento es el original de la fase de inicio del proyecto y
> **nunca se modifica** (ver [`docs/sys/workflow.md`](workflow.md), sección C). Los
> agentes AI tienen prohibido editarlo — un hook de Claude Code lo bloquea activamente.
> Para el estado actual del proyecto consulta la spec viva: [`spec.md`](spec.md).
